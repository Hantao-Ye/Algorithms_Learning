...
## 1.2.11 to 1.2.12 (1.2.19 including)  
...
By computing the square of the numbers, the results of the variances and the standard variances are less susceptible to the roundoff error.
